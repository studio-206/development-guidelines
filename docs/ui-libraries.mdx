...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://ariakit.org">Ariakit</a>
      </td>
      <td>
        an open source library that provides lower-level React components and hooks for building
        accessible web apps, design systems, and component libraries.
      </td>
      <td>Accessible Primitive components</td>
    </tr>
  </tbody>
</table>
;
